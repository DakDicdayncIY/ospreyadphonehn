...
public class MyApp extends Application {
	...
	// cur_down_view.setTextViewText(R.id.down_complete_text,
	// this.getResources().getString(R.string.down_complete_click));
	...
	// cur_down_view.setTextViewText(R.id.down_complete_text,
	// this.getResources().getString(R.string.down_londing_click));
	...
	// cur_down_view.setTextViewText(R.id.down_complete_text,
	// this.getResources().getString(R.string.down_fault_click));
	// cur_down_view.setTextViewText(R.id.progress_value,value+"%");
	// contentView.setProgressBar(R.id.progress_bar, 100, value, false);
	//
