...
public class DhbGrzxXjczFragment extends FragmentBase {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View view = inflater.inflate(R.layout.os_grzx_xjczfragment, container,
				false);
		initView(view);
		initData();
		return view;
	...
	private void initData() {
		// TODO Auto-generated method stub
		String account = SharepreferenceUtil.readString(act,
	 ...
	 * 
	 */
	public void pay(String price, String PARTNER, String SELLER,
			String TradeNo, String RSA_PRIVATE, String notify_url) {
		// 订单
		String orderInfo = getOrderInfo("充值", "鱼鹰充值", price, PARTNER, SELLER,
				TradeNo, notify_url);
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SDK_CHECK_FLAG: {
				Toast.makeText(act, "检查结果为：" + msg.obj, Toast.LENGTH_SHORT)
						.show();
				break;
			}
			default:
	...
	public String getOrderInfo(String subject, String body, String price,
			String PARTNER, String SELLER, String TradeNo, String notify_url) {
		// 签约合作者身份ID
	...
	private void getPrize(final String moneynum) {
		...
		HttpHelper.getInstances(act).send(FlowConsts.YYW_ZFB_CREATEORDER,
				...
				new CellComHttpInterface.NetCallBack<CellComAjaxResult>() {
					...
					public void onSuccess(CellComAjaxResult cellComAjaxResult) {
						...
						ZfbComm describeComm = cellComAjaxResult
								.read(ZfbComm.class,
