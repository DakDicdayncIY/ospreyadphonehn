...
public class DhbSyzxKykDetailActivity extends Activity {
  ...
  private Button ljlqbtn;
  private Button zqgdbtn;
  ...
  private void receiveIntentData() {
    if (getIntent().getSerializableExtra("syzxKykListBean") != null) {
      syzxKykList = (SyzxKykNewList) getIntent().getSerializableExtra("syzxKykListBean");
      if (syzxKykList != null) {
  ...
  private void initView() {
    ...
    ljlqbtn = (Button) findViewById(R.id.ljlqbtn);
    zqgdbtn = (Button) findViewById(R.id.zqgdbtn);
    ...
    popup.setAddAdapter(new AddAdapter() {
      ...
      public void addAdapter(ListView listview) {
        // TODO Auto-generated method stub
        adapter = new KykAdTypeAdapter(DhbSyzxKykDetailActivity.this, syzxKykTypeList);
  ...
  private void initListener() {
    ...
    ll_look_other.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (syzxKykTypeList.size() > 0) {
          popup.showAsDropDown(ll_look_other, -ll_look_other.getWidth(), 1,
              ll_look_other.getWidth() * 2, LayoutParams.WRAP_CONTENT);
        } else {
    ...
    popup.setItemClick(new ItemClick() {
      ...
      @Override
      public void setOnItemClick(AdapterView<?> arg0, View view, int position, long arg3) {
        // TODO Auto-generated method stub
        popup.dimissPopupwindow();
        // getKykInfos(((SyzxKykType) arg0.getItemAtPosition(position))
        // .getTypeid());
        if (((SyzxKykType) arg0.getItemAtPosition(position)).getVerytype().equals(typeid)) {} else {
          Intent intent = new Intent();
          intent.putExtra("title", ((SyzxKykType) arg0.getItemAtPosition(position)).getTypename());
          intent.putExtra("typeid", ((SyzxKykType) arg0.getItemAtPosition(position)).getVerytype());
    ...
    ljlqbtn.setOnClickListener(new OnClickListener() {
    ...
    zqgdbtn.setOnClickListener(new OnClickListener() {
  ...
  // } else if (moneytype.equals("2")) {
  // topiv.setText("当前广告没有亮币领取\n观看下一条广告");
  // } else if (moneytype.equals("3")) {
  // topiv.setText("当前广告没有银币领取\n观看下一条广告");
  // }
  // }
  //
  // if (money2!= null
  ...
  private void initData() {
    int height=(int)(ContextUtil.getWidth(this) * 1.2);
    adrl.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, height));
    if ("3".equals(typeid)) {
    ...
    if (syzxKykList != null && syzxKykList.getInfo() != null
      ...
      new Handler().postDelayed(new Runnable() {
        ...
        public void run() {
          // TODO Auto-generated method stub
          if (tv_detail.getHeight() >= ContextUtil.dip2px(DhbSyzxKykDetailActivity.this, 85)) {
            RelativeLayout.LayoutParams lp =
                new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.FILL_PARENT,
                    ContextUtil.dip2px(DhbSyzxKykDetailActivity.this, 85));
            lp.addRule(RelativeLayout.BELOW, R.id.tv_xxjs);
            lp.setMargins(ContextUtil.dip2px(DhbSyzxKykDetailActivity.this, 10),
                ContextUtil.dip2px(DhbSyzxKykDetailActivity.this, 5),
                ContextUtil.dip2px(DhbSyzxKykDetailActivity.this, 10),
                ContextUtil.dip2px(DhbSyzxKykDetailActivity.this, 10));
    ...
    if (syzxKykList.getLargepic() != null
      ...
      finalBitmap.display(iv_ad, syzxKykList.getLargepic(), ContextUtil.getWidth(this),
          (int) (ContextUtil.getWidth(this) * 1.2), false);
    }
    getKykType(false);
  ...
  private void getKykType(final boolean isShowPopup) {
    ...
    cellComAjaxParams.put("uid", SharepreferenceUtil.readString(DhbSyzxKykDetailActivity.this,
        SharepreferenceUtil.fileName, "uid", ""));
    HttpHelper.getInstances(DhbSyzxKykDetailActivity.this).send(FlowConsts.YYW_GETKYKTYPE,
        ...
        new CellComHttpInterface.NetCallBack<CellComAjaxResult>() {
          ...
          public void onSuccess(CellComAjaxResult cellComAjaxResult) {
            ...
            SyzxKykTypeComm syzxKykTypeComm =
                cellComAjaxResult.read(SyzxKykTypeComm.class, CellComAjaxResult.ParseType.GSON);
            if (!FlowConsts.STATUE_1.equals(syzxKykTypeComm.getReturnCode())) {
              Toast.makeText(DhbSyzxKykDetailActivity.this, syzxKykTypeComm.getReturnMessage(),
   ...
   */
  private void getNextAd(String ggid, String isCurrentGg, final boolean isLookMore) {
    if (SharepreferenceUtil.readString(DhbSyzxKykDetailActivity.this, SharepreferenceUtil.fileName,
        "uid", "").equals("")) {
      Intent loginintent = new Intent(DhbSyzxKykDetailActivity.this, LoginActivity.class);
    ...
    HttpHelper.getInstances(DhbSyzxKykDetailActivity.this).send(FlowConsts.YYW_GETLOOKGGINFO,
        cellComAjaxParams, CellComAjaxHttp.HttpWayMode.POST,
        new CellComHttpInterface.NetCallBack<CellComAjaxResult>() {
          ...
          public void onSuccess(CellComAjaxResult cellComAjaxResult) {
            ...
            ll_loading.setVisibility(View.GONE);
            KykAdComm kykAdComm =
                cellComAjaxResult.read(KykAdComm.class, CellComAjaxResult.ParseType.GSON);
            if (!FlowConsts.STATUE_1.equals(kykAdComm.getReturnCode())) {
              Toast.makeText(DhbSyzxKykDetailActivity.this, kykAdComm.getReturnMessage(),
                  Toast.LENGTH_SHORT).show();
              return;
            }
            kykadresult = kykAdComm.getBody();
            if (isLookMore) {
              Intent intent = new Intent(DhbSyzxKykDetailActivity.this, AdShowActivity.class);
              intent.putExtra("kykadresult", kykadresult);
              intent.putExtra("currentGgid", currentGgid);
              startActivityForResult(intent, 0);
            } else {
              if (kykadresult.getNextggid() != null && !kykadresult.getNextggid().trim().equals("")) {
                currentGgid = kykadresult.getNextggid();
                tvTopTitle.setText(kykadresult.getTitle());
                if (kykadresult != null && kykadresult.getData().size() > 0
                    && kykadresult.getData().get(0).getInfo() != null
                    && !kykadresult.getData().get(0).getInfo().trim().equals("")) {
                  tv_detail.setText(kykadresult.getData().get(0).getInfo());
                }
                if (kykadresult != null
                    && kykadresult.getData().size() > 0
                    && (kykadresult.getData().get(0).getMeitiurl().contains(".jpg") || kykadresult
                        .getData().get(0).getMeitiurl().contains(".png"))) {
                  finalBitmap.display(iv_ad, kykadresult.getData().get(0).getMeitiurl(),
                      ContextUtil.getWidth(DhbSyzxKykDetailActivity.this),
                      (int) (ContextUtil.getWidth(DhbSyzxKykDetailActivity.this) * 1.2), false);
                }
                if (kykadresult != null && kykadresult.getMoney1() != null
                    && !kykadresult.getMoney1().trim().equals("")) {
                ...
                Toast.makeText(DhbSyzxKykDetailActivity.this, "广告已播放完，暂时没有下一条广告了~",
                    Toast.LENGTH_SHORT).show();
              }
            }
          }
  ...
  private void getPrize(String ggid) {
    ...
    HttpHelper.getInstances(DhbSyzxKykDetailActivity.this).send(FlowConsts.YYW_GETLOOKMONEY,
        cellComAjaxParams, CellComAjaxHttp.HttpWayMode.POST,
        new CellComHttpInterface.NetCallBack<CellComAjaxResult>() {
          ...
          public void onSuccess(CellComAjaxResult cellComAjaxResult) {
            ...
            ll_loading.setVisibility(View.GONE);
            DescribeComm describeComm =
                cellComAjaxResult.read(DescribeComm.class, CellComAjaxResult.ParseType.GSON);
            if (!FlowConsts.STATUE_1.equals(describeComm.getReturnCode())) {
              Toast.makeText(DhbSyzxKykDetailActivity.this, describeComm.getReturnMessage(),
                  Toast.LENGTH_SHORT).show();
              return;
            }
            ...
            if (currentGgid.equals(syzxKykList.getGgid())) {// 当前广告为初始进入界面时的广告
              if (syzxKykList != null && syzxKykList.getMoney1() != null
                  && !syzxKykList.getMoney1().trim().equals("")) {
                if (syzxKykList.getMoneytype().equals("1")) {
                  CommonUtils.refreshLocalCaichan(DhbSyzxKykDetailActivity.this, "1",
                      syzxKykList.getMoney1());
                } else if (syzxKykList.getMoneytype().equals("2")) {
                  CommonUtils.refreshLocalCaichan(DhbSyzxKykDetailActivity.this, "2",
                      syzxKykList.getMoney1());
                } else if (syzxKykList.getMoneytype().equals("3")) {
                  CommonUtils.refreshLocalCaichan(DhbSyzxKykDetailActivity.this, "3",
                      syzxKykList.getMoney1());
                }

                // 播放动画，完毕后播放下一条广告
                ll_money_anim.removeAllViews();
                final FlakeView flakeView = new FlakeView(DhbSyzxKykDetailActivity.this);
                ll_money_anim.addView(flakeView);
                AnimationUtil.addScaleAnimation(tv_add_money_num, 1500);
                AnimationUtil.fadeInAnimation(DhbSyzxKykDetailActivity.this, iv_money_box);
