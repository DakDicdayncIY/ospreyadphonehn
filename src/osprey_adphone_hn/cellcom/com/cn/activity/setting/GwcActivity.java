...
public class GwcActivity extends ActivityFrame implements
...
//				tv_title2.setTextColor(getResources().getColor(R.color.gray));
				tv_title1.setTextColor(getResources().getColor(R.color.blue));
		...
		btn_comfirm_pay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(cb_hint.isChecked()){
					...
					Toast.makeText(GwcActivity.this, "您还没勾选支付协议~", Toast.LENGTH_SHORT).show();
				}
			}
		});
