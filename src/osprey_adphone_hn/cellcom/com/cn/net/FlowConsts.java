...
public class FlowConsts {
	...
	// "http://183.6.172.138:8081/yywapp/";
	...
	// 获取通话记录
	public static String YYW_GETCALL_LOGLIST = SERVICE_IP
			+ "/yyw_getcall_loglist.flow";
	// // 拨打电话
	...
	public static String YYW_GETKYKTYPE = SERVICE_IP
			+ "/yyw_getkyktype_new.flow";
	...
	public static String YYW_GETZHUANLIST = SERVICE_IP
			+ "/yyw_getzhuanlist.flow";
	...
	public static String YYW_ZHUANCHOUJIANG = SERVICE_IP
			+ "/yyw_zhuanchoujiang.flow";
	...
	public static String YYW_GETHOUSE = SERVICE_IP + "/yyw_gethouse.flow";
	// 获取全部省份列表
	public static String YYW_GETAREALIST = SERVICE_IP + "yyw_getarealist.flow";
	// 家生活绑定、修改设备接口
	public static String YYW_SETDEVICE = SERVICE_IP + "/yyw_setdevice.flow";
	// 家生活删除设备接口
	public static String YYW_DELDEVICE = SERVICE_IP + "/yyw_deldevice.flow";

	// 家生活获取物管信息接口 yyw_getwginfo
	public static String YYW_GETWGINFO = SERVICE_IP + "/yyw_getwginfo.flow";

	// 注册2cu成功回调接口
	public static String YYW_REG2CU = SERVICE_IP + "/yyw_reg2cu.flow";

	// 获取兑换率规则接口 yyw_getrate
	public static String YYW_GETRATE = SERVICE_IP + "/yyw_getrate.flow";
	...
	// 获取冠名广告
	public static String YYW_GETAD_NAEMED = SERVICE_IP
			+ "/yyw_getad_named.flow";
	// 扫一扫领奖（新版 150429）
	public static String YYW_SAO_GETWIN = SERVICE_IP + "/yyw_sao_getwin.flow";
	// 获取订单号
	public static String YYW_ZFB_CREATEORDER = SERVICE_IP
			+ "/yyw_zfb_createorder.flow";
	// 抢红包列表
	public static String YYW_GETREDPACKEDLIST = SERVICE_IP
			+ "/yyw_getredpackedlist.flow";
	// 预约抢红包
	public static String YYW_MAKEROB = SERVICE_IP + "/yyw_makerob.flow";
	// 抢红包
	public static String YYW_ROBREDPACKED = SERVICE_IP
			+ "/yyw_robredpacked.flow";
	...
	public static void refleshIp(String urlString) {
		...
		// // 商品类别获取接口 yyw_shop_getvarietylist
		// YYW_SHOP_GETVARIETYLIST = urlString +
		// "/yyw_shop_getvarietylist.flow";
		// // 商品列表接口yyw_shangpin_list
